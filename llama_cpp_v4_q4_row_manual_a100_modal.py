...
os.environ.setdefault("LLAMA_CPP_APP_NAME", "deepseek-v4-flash-llama-cpp-q4-row-manual-a100")
...
os.environ.setdefault("LLAMA_CPP_SPLIT_MODE", "row")
os.environ.setdefault("LLAMA_CPP_TENSOR_SPLIT", "1,1,1,1")
os.environ.setdefault("LLAMA_CPP_MAIN_GPU", "0")
