...
os.environ.setdefault("LLAMA_CPP_APP_NAME", "deepseek-v4-flash-llama-cpp-q4-flashon-a100")
...
os.environ.setdefault(
    ...
    "--flash-attn on --cache-ram 0 --no-warmup --batch-size 2048 --ubatch-size 512 --poll 100 --poll-batch 1",
)
