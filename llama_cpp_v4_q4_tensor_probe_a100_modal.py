...
os.environ.setdefault("LLAMA_CPP_APP_NAME", "deepseek-v4-flash-llama-cpp-q4-tensor-probe-a100")
...
os.environ.setdefault("LLAMA_CPP_SPLIT_MODE", "tensor")
os.environ.setdefault("LLAMA_CPP_CACHE_TYPE_K", "f16")
os.environ.setdefault("LLAMA_CPP_CACHE_TYPE_V", "f16")
os.environ.setdefault("CUDA_SCALE_LAUNCH_QUEUES", "4x")
os.environ.setdefault("GGML_CUDA_P2P", "1")
os.environ.setdefault(
    "LLAMA_CPP_EXTRA_SERVER_ARGS",
    "--flash-attn on --cache-ram 0 --no-warmup --batch-size 2048 --ubatch-size 512",
)
