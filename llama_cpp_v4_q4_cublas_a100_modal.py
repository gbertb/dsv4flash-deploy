...
os.environ.setdefault("LLAMA_CPP_APP_NAME", "deepseek-v4-flash-llama-cpp-q4-cublas-a100")
...
os.environ.setdefault("LLAMA_CPP_CMAKE_EXTRA_ARGS", "-DGGML_CUDA_FORCE_CUBLAS=ON")
