...
os.environ.setdefault(
    "LLAMA_CPP_APP_NAME",
    "deepseek-v4-flash-llama-cpp-q4-peer512-conc2-a100",
)
...
os.environ.setdefault("LLAMA_CPP_PARALLEL", "1")
os.environ.setdefault("LLAMA_CPP_CMAKE_EXTRA_ARGS", "-DGGML_CUDA_PEER_MAX_BATCH_SIZE=512")
os.environ.setdefault("LLAMA_CPP_ONLINE_CONCURRENCY", "2")
os.environ.setdefault("LLAMA_CPP_ONLINE_MATRIX", "128x256,1024x256")
